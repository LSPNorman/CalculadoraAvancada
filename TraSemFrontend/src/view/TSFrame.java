...
public class TSFrame extends JFrame
{
	...
	public static EquacoesLinearesEQuadraticas eLeQ;
	public static EstudoDoTriangulo estudoDoTriangulo;
	...
	public TSFrame()
	{
		...
		eLeQ = new EquacoesLinearesEQuadraticas();
		eLeQ.setBounds(20,20,900,650);
		eLeQ.setVisible(false);
		eLeQ.setEnabled(false);
		this.add(eLeQ);
		
		estudoDoTriangulo = new EstudoDoTriangulo();
		estudoDoTriangulo.setBounds(20,20,900,650);
